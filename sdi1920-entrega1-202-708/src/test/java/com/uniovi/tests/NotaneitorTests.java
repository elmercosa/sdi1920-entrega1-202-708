...
public class NotaneitorTests {
	...
	static String Geckdriver024 = "D:\\Jaime\\Repositorios\\sdi1920-entrega1-202-708\\sdi1920-entrega1-202-708\\sdi1920-entrega1-202-708\\geckodriver024win64.exe";
...
//		PO_View.checkElement(driver, "text", "Notas del usuario");
		...
		// Refactorizado
		PO_PrivateView.checkLogin(driver, "login", "class", "btn btn-primary", "99999990A", "123456", "text",
				"Notas del usuario");
...
//		PO_PrivateView.clickOption(driver, "logout", "text", "Identifícate");
		...
		// Refactorizado
		PO_PrivateView.checkLogout(driver, "logout", "text", "Identifícate");
	}
...
//		PO_View.checkElement(driver, "text", "99999993D");
		...
		// Refactorizado
		PO_PrivateView.checkLogin(driver, "login", "class", "btn btn-primary", "99999993D", "123456", "text",
				"99999993D");
